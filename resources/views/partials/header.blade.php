...
<nav class="navbar navbar-default" style="background-color:#ffff00">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="{{ route('shops.index') }}"><i class="fa fa-mobile" aria-hidden="true"></i>Mobile Phones</a>
    </div>
  ...
  <button type="submit" class="btn btn-default"><i class="glyphicon glyphicon-search"></i></button>
    ...
    <i class="fa fa-mobile" aria-hidden="true"></i>Products
    </a>
    </li>
    ...
    <i class="fa fa-user" aria-hidden="true"></i>Customer
          ...
          <ul class="dropdown-menu">
            @if (Auth::check())
              ...
              <li><i class="fa fa-id-card" aria-hidden="true"><a href="{{ route('user.employee') }}"></i>Employee Signup</a></li>
